# ------------------------------------------------------------------------------------------------- #
# Title: Presentation Class Module
# # Description: A presentation class for managing the application
...
class IO:
    ...
    def input_employee_data(employee_data: list, employee_type: object):
        ...
        ChangeLog: (Who, When, What)
        Tellrell White, 06.12.2525, Created function

        :param employee_type: reference to Employee class imported through main module
